            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-6 col-md-auto text-center text-sm-start">
                    <div class="footer1-logo bg-white">
                        <a href="index.html"><img src="{{asset('design-site/img/logo.svg')}}"
                        alt="Logo"></a>
                    </div>
                    </div>
                            ...
                            <div class="vs-widget-about">
                                ...
                                <h4><a class="text-theme hover-white" href="tel:693232512456">
                                    ...
                                    <div class="d-flex mt-3 pt-1">
                                        <div class="avater-small mr-20"><img src="{{asset('design-site/img/author/author-2-3.jpg')}}"
                                                    ...
                                                    <div class="col-md-6 col-lg-3 col-xl-3">
                                                        <div class="widget footer-widget">
                                                            ...
                                                            <div class="address-line">
                                                                ...
                                                                <a href="#"class="text-reset fs-md"></a>{{$address->description}}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
